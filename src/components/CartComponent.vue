...
<template>
  <div class="card">
    <div
      ...
      class="relative justify-center h-10 w-24 promotion rounded-e-3xl top-16 text-white font-medium items-center flex text-md">
      {{ promotion }}
    </div>
    <div
      class="Item w-72 pb-5 bg-white rounded-md flex-col justify-center items-center gap-2.5 inline-flex">
      <img class="bg-cover rounded-t-md Img w-72 h-72" :src="image" />
